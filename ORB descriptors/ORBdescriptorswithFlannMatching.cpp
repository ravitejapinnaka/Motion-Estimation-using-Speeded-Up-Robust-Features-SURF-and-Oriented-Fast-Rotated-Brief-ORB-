...
int main( int argc, char** argv )
{
    ...
    f2d->detect(img_1, keypoints_1);// detecting keypoints for first frame using ORB algorithm
    ...
    f2d->detect(img_2, keypoints_2);// detecting keypoints for second frame using ORB algorithm
    ...
    for(;;) // infinite loop
    {
        ...
        f2d->detect(img_2, keypoints_2);// detecting keypoints for frame_gray2 using ORB algorithm
        f2d->compute(img_2, keypoints_2, descriptors_2);//computing descriptors for keypoints_2
        descriptors_2.convertTo(descriptors_2, CV_32F);
